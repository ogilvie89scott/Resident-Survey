  ...
  dashboardSidebar(disable = T, # Change this to false to add tabs or display this existing one.
    sidebarMenu(
      menuItem("Analysis Q1 & Q3",
             tabName = "Analysis",
              icon = icon("signal"))#,
      # menuItem("Analysis Q2 & Q4",
      #        tabName = "Analysis2",
      #        icon = icon("city")) # can use this to create a new tab
      )
    ),
  # BODY --------------------------------------------------------------------
                             ...
                             fluidRow(
                               box(
                                 selectInput( # how to select the Y variables.
                                   "ycol",
                                   "Y Variables:",
                                   c(# changing these will change the options from the drop down box.
                                     "method" ,
