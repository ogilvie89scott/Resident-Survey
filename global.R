...
# Collapsing the race levels
kcmo_mar_2022$q37_race <- fct_collapse(
...
# Filter out Don't Knows----

kcmo_mar_2022_nodk <- remove_all_dont_know(kcmo_mar_2022, dk = NULL)

# Filter out Don't Knows----
kcmofy2022_b_nodk <- remove_all_dont_know(kcmofy2022_b, dk = NULL)
...
# Combine data ----
# Example for next quarter: resident_survey<-bind_rows(resident_survey,kcmo_mar_2021)
...
options(scipen = 999)
# Grab a list to filter by quarter in the app
list1 <- unique(resident_survey$quarter)
